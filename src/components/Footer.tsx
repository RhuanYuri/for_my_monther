...
export function Footer() {
  return (
    <footer className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#1a1208_0%,#311d13_100%)] px-5 py-24 text-[var(--cream)] sm:px-8 lg:px-12 2xl:px-16 2xl:py-32 2xl:min-h-dvh">
      ...
      <div className="mx-auto max-w-5xl text-center 2xl:max-w-6xl">
        <p className="font-body text-xs tracking-[0.48em] text-[rgba(250,243,224,0.62)] uppercase 2xl:text-sm 2xl:tracking-[0.56em]">
          Com Amor
        </p>
        <h2 className="mt-6 font-display text-[clamp(3.2rem,8vw,8.2rem)] leading-[0.9] tracking-[0.06em]">
          você e amor que permanece, mesmo quando o tempo passa.
        </h2>
        <p className="mx-auto mt-6 max-w-3xl font-body text-lg leading-8 text-[rgba(250,243,224,0.72)] 2xl:max-w-4xl 2xl:text-xl 2xl:leading-10">
        ...
        <p className="mt-4 font-script text-4xl text-[rgba(232,146,124,0.95)] 2xl:text-5xl">Com amor Rhuã, Andressa e Sandy</p>
      </div>
