...
export function ScrollProgress({
  ...
  return (
    <div className="fixed top-1/2 right-3 z-40 hidden -translate-y-1/2 xl:flex xl:flex-col xl:items-center xl:gap-4">
      <div className="relative h-56 w-2 overflow-hidden rounded-full bg-[rgba(193,105,79,0.14)]">
        <motion.div
      ...
      <div className="flex flex-col items-center gap-3">
        {sections.map((section, index) => (
          <motion.div
            ...
            className="rounded-full bg-[rgba(250,243,224,0.75)] p-2 text-[var(--terracota)] shadow-sm"
            title={section.label}
          >
