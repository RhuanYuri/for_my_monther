...
export function Gallery() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#faf3e0_0%,#f5e6d7_35%,#f9f2e8_100%)] px-5 py-24 sm:px-8 lg:px-12 2xl:min-h-dvh 2xl:py-32">
      ...
      <div className="mx-auto max-w-6xl 2xl:max-w-7xl">
        <div className="mb-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-6 font-display text-[clamp(2.8rem,6vw,6.8rem)] leading-[0.9] text-[var(--preto-elegante)]">
        ...
        <motion.div layout className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
